# RTMO-M (Body7, 640x640) — MMPose config, vendored into this repository.
#
# Source: open-mmlab/mmpose v1.3.2
#   configs/body_2d_keypoint/rtmo/body7/rtmo-m_16xb16-600e_body7-640x640.py
#
# Pairs with checkpoint:
#   rtmo-m_16xb16-600e_body7-640x640-39e78cc4_20231211.pth
#   https://download.openmmlab.com/mmpose/v1/projects/rtmo/
#       rtmo-m_16xb16-600e_body7-640x640-39e78cc4_20231211.pth
#
# The ONLY edit against upstream is the _base_ line below. Upstream declares
#   _base_ = ['../../../_base_/default_runtime.py']
# which only resolves inside the mmpose config tree. default_runtime.py is
# load-bearing (it supplies `default_scope = 'mmpose'`, without which
# init_model cannot resolve the model registry), so it is vendored next to
# this file and referenced with a sibling-relative path instead.
#
# Docker build copies this whole directory to /opt/models/rtmo/.
# The train_* / val_* / test_* sections are kept verbatim rather than stripped:
# init_model reads test_dataloader to derive dataset_meta, and keeping the file
# a faithful copy makes it trivial to diff against a future MMPose release.
